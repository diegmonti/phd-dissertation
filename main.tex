...
\nomenclature{\textit{content-based recommender system}:}{a recommendation approach based on the characteristics of the items and the preferences of the users.}
