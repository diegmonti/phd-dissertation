...
% Glossary
\nomenclature{\textit{collaborative filtering}}{A recommendation approach based on the rating behaviour of similar users on similar items.}
\nomenclature{\textit{content-based recommender system}}{A recommendation approach based on the match between the preferences of the users and the characteristics of the items.}
...
\nomenclature{\textit{online evaluation}}{An experimental approach that consists in making a recommender system available to a potentially large community of users.}
...
\nomenclature{\textit{recommender system}}{A software tool and an algorithm designed to suggest items to users according to their preferences.}
