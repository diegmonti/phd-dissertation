...
\item[RQ4\label{int:itm:rq4}] To what extend the structure of a rating dataset can influence the results of an offline evaluation?
\end{description}
...
\item[RQ4.2] \added{To what extent the graphical representation of different rating datasets can be useful to easily identity their similarities and diversities?}
\end{description}
...
\item[RQ4.5] \added{To what extend this method can be consistently applied to datasets from different domains and of different sizes?}
\end{description}
