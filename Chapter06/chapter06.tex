...
\item[RQ4.2\label{viz:itm:rq2}] \added{To what extent the graphical representation of different rating datasets can be useful to easily identity their similarities and diversities?}
\end{description}
